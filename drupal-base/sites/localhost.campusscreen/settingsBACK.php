 ...
 * @endcode
 */
$settings['hash_salt'] = 'dtWfmePUVBl39-1-BwOeu82uBeXWpg9HE06SU6hGfHvA30Dx4tjMhwsPR5WRWhrBWTdErQChiw';
 ...
 */
 $settings['file_public_base_url'] = '/files/campusscreen';
...
#	echo __DIR__ . '/settings.local.php';
	include __DIR__ . '/settings.local.php';
 }

$databases['default']['default'] = array (
  'database' => '8d_campusscreen',
  'username' => 'root',
  'password' => 'narahuee7@',
  'prefix' => '',
  'host' => 'localhost',
...
$config_directories['sync'] = 'sites/ic-dev.cs.upei.ca.campusscreen/files/config_vWjVRWmd0PotLq6HhhbNPurJhJc_Nw1ilpzBUCvSRsordZrZvWVNG3QRsK_NfaxUMkdR7ZzyIQ/sync';
